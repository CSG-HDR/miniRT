...
static const bool	g_map[256] = {
	...
	g_f, g_f, g_t, g_t, g_t, g_t, g_t, g_t, // 0070 ~ 0077
	g_t, g_f, g_f, g_f, g_f, g_f, g_f, g_f, // 0100 ~ 0107
	g_f, g_f, g_f, g_f, g_f, g_f, g_f, g_f, // 0110 ~ 0117
	g_f, g_f, g_f, g_f, g_f, g_f, g_f, g_f, // 0120 ~ 0127
	g_f, g_f, g_f, g_t, g_t, g_t, g_t, g_t, // 0130 ~ 0137
	g_t, g_f, g_f, g_f, g_f, g_f, g_f, g_f, // 0140 ~ 0147
	g_f, g_f, g_f, g_f, g_f, g_f, g_f, g_f, // 0150 ~ 0157
	g_f, g_f, g_f, g_f, g_f, g_f, g_f, g_f, // 0160 ~ 0167
	g_f, g_f, g_f, g_f, g_t, g_t, g_t, g_f, // 0170 ~ 0177
